// pages/lm_history/lm_history.js
...
Page({
  ...
  onLoad: function (options) {
    ...
    that.ajaxlist(options.billnumbers)
    that.couterlist(options.billnumbers)
    that.setData({
      bill: options.billnumbers
    })
  },
  ajaxlist: function (billnumbers) {
    var that = this;
    wx.request({
  ...
  // 获取center列表
  couterlist: function (billnumbers) {
    var that = this
  ...
  onShareAppMessage: function () {
    ...
    return {
      title: '发送码单',
      path: 'pages/codes/codes?opendsset=' + opends + '&bill=' + that.data.bill,
    }
  }
})